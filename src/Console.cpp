...
void Console::parseCommand()
{
    ...
    m_historyIndex = static_cast<sf::Uint8>(m_commandHistory.size());
    updateText();
}
...
void Console::setBackgroundColor(sf::Color theColor)
{
  m_backgroundRect.setFillColor(theColor);
}
